        ...
        <div class="container">
            <div class="col-xs-12 col-md-6 col-md-offset-3">
                ...
                <form action="RegisterServlet.do" class="form-register"  >
                    ...
                    <input type="email" id="username" name="username" class="form-control" placeholder="Email"  autofocus="" <%= errorclass%>>
                    <label for="password"  >Password</label>
                    <input type="password" name="password"  class="form-control" placeholder="Password"  <%= errorclass%>>
                    <br>
